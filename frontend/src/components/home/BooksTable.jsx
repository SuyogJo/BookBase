...
export default function BooksTable({books}) {
  return (
    <table className='w-full border-seperate-2'>
        <thead>
        <tr>
        ...
        {books.map((book) => 
            ...
            <th className='border border-slate-700 rounded-md text-center'>{books.indexOf(book)+1}</th>
            <th className='border border-slate-700 rounded-md text-center'>{book.title}</th>
            <th className='border border-slate-700 rounded-md text-center max-md:hidden' >{book.author}</th>
